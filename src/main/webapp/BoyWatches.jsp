...
<div class="hero-section">
    <img src="imges/img_28.png"  class="hero-image">
</div>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-3">
            <div class="product-card">
                ...
                <a href="boy1.jsp">                 <img src="imges/img_29.png" alt="Tissot Watch with Blue Dial" class="product-image">
                </a>
                <h5>PRX 35mm</h5>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="product-card">
                <button class="favorite-btn">♡</button>
                <a href="boy2.jsp">                 <img src="imges/img_30.png" alt="Tissot Watch with Blue Dial" class="product-image">
                </a>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="product-card">
                <button class="favorite-btn">♡</button>
                <a href="boy3.jsp">                 <img src="imges/img_31.png" alt="Tissot Watch with Blue Dial" class="product-image">
                </a>
                <h5>PRX 35mm</h5>
        ...
        <div class="col-md-6 col-lg-3">
            <div class="product-card">
                <button class="favorite-btn">♡</button>
                <a href="boy4.jsp">                 <img src="imges/img_32.png" alt="Tissot Watch with Blue Dial" class="product-image">
                </a>
                <h5>PRX Powermatic 80</h5>
                <p class="text-muted">Automatic</p>
            </div>
